...
import { saveViewerInteractions } from '../../../platform/app/src/utils/helper';
...
function commandsModule({
  ...
  const actions = {
    ...
    removeAnnotations: () => {
      ...
      saveViewerInteractions(
        {
          tool_name: 'removeAnnotations',
          tool_action: 'removeAnnotations',
          study_id: '',
          series_id: '',
          additional_data: ''
        }
    ...
    toggleCine: () => {
      ...
      if (!isCineEnabled) {
        saveViewerInteractions(
          {
            tool_name: 'cine',
            tool_action: isCineEnabled ? 'disable' : 'enabled',
            study_id: '',
            series_id: '',
            additional_data: ''
          }
    ...
    flipViewportHorizontal: () => {
      ...
      saveViewerInteractions(
        {
          tool_name: 'flipViewportHorizontal',
          tool_action: 'flip',
          study_id: '',
          series_id: '',
          additional_data: ''
    ...
    flipViewportVertical: () => {
      ...
      saveViewerInteractions(
        {
          tool_name: 'flipViewportVertical',
          tool_action: 'flip',
          study_id: '',
          series_id: '',
          additional_data: ''
    ...
    scaleViewport: ({ direction }) => {
      ...
      saveViewerInteractions(
        {
          tool_name: 'scaleViewport',
          tool_action: 'scaleViewport',
          study_id: '',
          series_id: '',
          additional_data: ''
        }
    ...
    jumpToImage: ({ imageIndex, viewport: gridViewport }): void => {
      ...
      saveViewerInteractions(
        {
          tool_name: 'jumpToImage',
          tool_action: 'jumpToImage',
          study_id: '',
          series_id: '',
          additional_data: ''
        }
    ...
    changeActiveViewport: ({ direction = 1 }) => {
      ...
      saveViewerInteractions(
        {
          tool_name: 'changeActiveViewport',
          tool_action: 'changeActiveViewport',
          study_id: '',
          series_id: '',
          additional_data: ''
        }
    ...
    toggleSynchronizer: ({ type, viewports, syncId }) => {
      ...
      saveViewerInteractions(
        {
          tool_name: 'toggleSynchronizer',
          tool_action: 'toggleSynchronizer',
          study_id: '',
          series_id: '',
          additional_data: ''
        }

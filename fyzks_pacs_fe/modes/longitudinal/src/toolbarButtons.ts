...
const toolbarButtons: Button[] = [
  ...
  },
  {
    ...
    uiType: 'ohif.toolButton',  // Changed from 'ohif.radioGroup'
    props: {
      type: 'tool',
      icon: 'icon-tool-ctr', // Use existing icon temporarily
      label: 'Cardio-Thoracic Ratio',
      tooltip: 'Cardio-Thoracic Ratio Tool',
      commands: setToolActiveToolbar,  // Use the same command structure as other tools
      evaluate: 'evaluate.cornerstoneTool',
    },
  },
  {
    ...
    props: {
      type: 'tool',
      icon: 'tool-spine', // You'll need to add this icon
      label: 'Spine Labeling',
      tooltip: 'Sequential Spine Labeling Tool',
      commands: setToolActiveToolbar,
      evaluate: 'evaluate.cornerstoneTool',
    },
  },

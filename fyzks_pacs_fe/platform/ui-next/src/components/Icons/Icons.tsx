...
export const Icons = {
  ...
  'tool-separator': (props: IconProps) => VerticalSeparatorThick(props),
  ...
  'icon-tool-ctr': (props: IconProps) => ToolCTR(props),
  'tool-spine': (props: IconProps) => ToolSpineLabel(props),
  'tool-auto-zoom': (props: IconProps) => ToolAutoZoom(props),
  ...
  'cancel': (props: IconProps) => Cancel(props),
